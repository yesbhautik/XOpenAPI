...
st.write("##### JSON")
st.write(f"{base_url}/search/example_keyword?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("##### FEED/RSS")
st.write(f"{base_url}/search/example_keyword/feed?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("### Strict Search Example")
st.write("##### JSON")
st.write(f"{base_url}/strict-search/example_keyword?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("##### FEED/RSS")
st.write(f"{base_url}/strict-search/example_keyword/feed?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("### Profile Search Example")
st.write("##### JSON")
st.write(f"{base_url}/profile-information/example_user")
st.write("##### FEED/RSS")
st.write(f"{base_url}/profile-information/example_user/feed")
st.write("### Hashtag Example")
st.write("##### JSON")
st.write(f"{base_url}/hashtag/example_keyword?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("##### FEED/RSS")
st.write(f"{base_url}/hashtag/example_keyword/feed?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("### User's Latest Example")
st.write("##### JSON")
st.write(f"{base_url}/latest-tweet/example_user?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("##### FEED/RSS")
st.write(f"{base_url}/latest-tweet/example_user/feed?minLikes=10&minReplies=5&minRetweets=2&language=en")
