...
st.write("##### JSON")
st.write(f"{base_url}/search/spacex?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("##### FEED/RSS")
st.write(f"{base_url}/search/spacex/feed?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("### Strict Search Example")
st.write("##### JSON")
st.write(f"{base_url}/strict-search/spacex?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("##### FEED/RSS")
st.write(f"{base_url}/strict-search/spacex/feed?minLikes=10&minReplies=5&minRetweets=2&language=en")
...
st.write("##### JSON")
st.write(f"{base_url}/hashtag/spacex?minLikes=10&minReplies=5&minRetweets=2&language=en")
st.write("##### FEED/RSS")
st.write(f"{base_url}/hashtag/spacex/feed?minLikes=10&minReplies=5&minRetweets=2&language=en")
